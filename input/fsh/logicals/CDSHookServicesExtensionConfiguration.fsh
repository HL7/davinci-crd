Logical: CDSHookServicesExtensionConfiguration
...
* code from CRDCardType    (required)
* type 1..1 code "boolean | integer (JSON types)" "A data type for the parameter."
* type from CRDConfigTypes (extensible)
