...
### CRD Access Tokens
<a name="FHIR-49742"> </a>
<p class="modified-content" markdown="1">When a CRD client invokes a CRD server via CDS Hooks, it <b>SHALL</b> provide an access token that allows the CRD server to retrieve additional patient information. The base rules for this token are defined in the [CDS Hooks specification]({{site.data.fhir.ver.cdshooks}}/index.html#passing-the-access-token-to-the-cds-service). This specification imposes some additional constraints:</p>
