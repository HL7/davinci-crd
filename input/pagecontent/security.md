...
<div class="fhir-conformance new-content" id="sec-9^crd-client-org^processing" summary="Access tokens provided as part of CRD calls **SHOULD NOT** be forwarded to systems that are not managed by the same organization or have business associate agreements that allow centralized audit of access.">
