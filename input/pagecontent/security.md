...
<div class="new-content" markdown="1"><div class="fhir-conformance" id="sec-9^crd-client-org^processing" summary="Access tokens provided as part of CRD calls **SHOULD NOT** be forwarded to systems that are not managed by the same organization or have business associate agreements that allow centralized audit of access."><a name="FHIR-55757"> </a>
...
There is not a lot of experience around delegated access with CDS Hooks and the timing requirements make it even more challenging.  Implementers should expect additional negotiations to happen around how this will function.  Future versions of this specification might provide additional guidance or constraints.
</blockquote>
</div>
