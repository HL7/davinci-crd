...
### Usage
<br/>
CRD Clients **SHALL** use this profile to [resolve references](foundation.html#additional-data-retrieval) to Practitioner resources passed to CRD Servers, including `userId` context references when invoking the following CDS Hooks:
