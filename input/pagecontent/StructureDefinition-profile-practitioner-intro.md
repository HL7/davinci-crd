...
### Usage
<br/>
CRD Clients SHALL use this profile to [resolve references](hooks.html#additional-data-retrieval) to Practitioner resources passed to CRD Services, including `userId` context references when invoking the following CDS Hooks:
