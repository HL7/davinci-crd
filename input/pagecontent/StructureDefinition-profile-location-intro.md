...
§prof-8^crd-client^exchange:CRD Clients **SHALL** use the CRD Location profile to [resolve references](foundation.html#additional-data-retrieval) to insurance Location resources passed to CRD Servers.§
