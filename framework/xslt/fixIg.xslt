...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://hl7.org/fhir" xmlns:f="http://hl7.org/fhir" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xsi xs f">
  ...
  <xsl:template match="@xsi:schemaLocation|f:extension[@url='http://hl7.org/fhir/tools-profile-spreadsheet' or @url='http://hl7.org/fhir/StructureDefinition/tools-alternateVersion']"/>
  ...
  <xsl:template match="f:page[*[self::f:source or self::f:nameUrl][starts-with(@value,'artifacts') and substring(@value, string-length(@value)-5)='.html']]">
    <xsl:if test="@value=concat('artifacts', $version, '.html')">
      ...
      <xsl:copy>
        ...
        <xsl:if test="not(f:page[f:format/@value='generated'])">
          ...
          <xsl:for-each select="ancestor::f:ImplementationGuide/f:package/f:resource|ancestor::f:ImplementationGuide/f:definition/f:resource">
            <xsl:if test="(not(f:extension[@url='http://hl7.org/fhir/StructureDefinition/tools-alternateVersion']) and $version='') or f:extension[@url='http://hl7.org/fhir/StructureDefinition/tools-alternateVersion']/f:valueCode/@value=$version">
              <page>
